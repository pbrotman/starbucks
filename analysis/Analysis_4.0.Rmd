...
```{r}
tbl <- tbl_modeling %>% 
  select(log_n, log_Total, `Management,_business,_science,_and_arts_occupations`: `Production,_transportation,_and_material_moving_occupations`)
...
```{r}
tbl <- tbl_modeling %>% 
  select(log_n, log_Total, Region, `Management,_business,_science,_and_arts_occupations`: `Production,_transportation,_and_material_moving_occupations`)
